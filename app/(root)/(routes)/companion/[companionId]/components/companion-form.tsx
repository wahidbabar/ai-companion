...
const formSchema = z.object({
  ...
  seed: z.string().min(200, {
    message: "Seed required at lease 200 characters.",
  }),
  src: z.string().min(1, {
      ...
      <Form {...form}>
        ...
        >
          <div className="space-y-2 w-full">
            <div>
              <h3 className="text-lg font-md">General Information</h3>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-3 md:col-span-1">
                ...
                <FormDescription>
                  Describe in detail your companions backstory and relevant
                  details.
                </FormDescription>
                <FormMessage />
              </FormItem>
